...
async function updateTransactionCost(transaction: TransactionWithStats, depth: number, costProportion : number ,impactResponse:ImpactResponse): Promise<ImpactResponse> {
    ...
    let newTransactionCost : TransactionCost;
    newTransactionCost.transaction = transaction;
    newTransactionCost.impactTxs = 1.0;
    newTransactionCost.relativeImpactTxs = costProportion;
    newTransactionCost.relativeImpactKwh = energyPerTransaction*costProportion;
